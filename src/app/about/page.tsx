  ...
  const features = [
    {
      ...
      description:
        'Experience peace of mind with our state-of-the-art secure payment systems and dedicated 24/7 customer support. We ensure that every step of your reservation process is effortless, transparent, and completely protected.',
      image: '/aboutsecurity (2).webp',
    },
    {
      id: 2,
      icon: Building2,
      ...
      description:
        'We meticulously handpick every hotel and accommodation to guarantee an unparalleled experience. From luxurious modern suites to charming traditional Persian guesthouses.',
      image: '/aboutroom.webp',
    },
    {
      id: 3,
      icon: Globe2,
      ...
      description:
        'No matter where your wanderlust takes you in Iran, we are there. Explore the ancient magnificent streets of Isfahan, or the serene poetry of Shiraz, knowing we have the perfect stay waiting for you.',
      image: '/about.webp',
    },
  ];

  return (
    // پدینگ‌های اضافی رو برداشتم تا w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 خودش مدیریت فاصله‌ها رو انجام بده
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 sm:mb-24">
          ...
          <p className="text-sm sm:text-base lg:text-lg text-slate-600 leading-relaxed max-w-2xl mx-auto text-left sm:text-center">
            PersiaStay is your premier gateway to unforgettable journeys across Iran. We blend
            modern convenience with authentic Persian hospitality to bring you a curated selection
            of the finest stays and experiences.
          </p>
        </div>
        ...
        >
          ...
          <p className="text-sm sm:text-base lg:text-lg text-slate-600 leading-relaxed max-w-2xl mx-auto mb-8 sm:mb-10 text-center px-2">
            The finest hotels and experiences are waiting for you. Let us help you discover the true
            magic of Persia.
          </p>
          <Link
            href="/"
