        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-6">
          ...
          <div className="hidden md:flex flex-col space-y-3">
            ...
            <div className="flex flex-wrap gap-2">
              <a
                href="#"
                aria-label="صفحه فیسبوک hotelBook"
                className="p-1.5 bg-gray-800 rounded-full hover:bg-gray-700 transition-colors text-gray-300"
              >
                <svg
                  width="14"
                  height="14"
              ...
              <a
                href="#"
                aria-label="صفحه اینستاگرام hotelBook"
                className="p-1.5 bg-gray-800 rounded-full hover:bg-gray-700 transition-colors text-gray-300"
              >
                <svg
                  width="14"
              ...
              <a
                href="#"
                aria-label="صفحه توییتر hotelBook"
                className="p-1.5 bg-gray-800 rounded-full hover:bg-gray-700 transition-colors text-gray-300"
              >
                <svg
                  width="14"
              ...
              <a
                href="#"
                aria-label="کانال یوتیوب hotelBook"
                className="p-1.5 bg-gray-800 rounded-full hover:bg-gray-700 transition-colors text-gray-300"
              >
                <svg
                  width="14"
            ...
            <p className="text-gray-400 text-xs leading-relaxed">
              Find your perfect stay with the best deals on hotels, homes, and unforgettable
