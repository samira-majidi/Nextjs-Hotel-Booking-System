...
import Link from 'next/link'; // ✨ این رو اضافه کردیم

import { Destination } from '../../hotel/model/types/destination';
...
export default function DestinationCard({ destination }: Props) {
  return (
    // ✨ div رو به Link تبدیل کردیم و آدرس‌دهی کردیم
    <Link
      href={`/hotels?cityId=${destination.id}`}
      className="group relative flex w-full cursor-pointer items-center rounded-2xl bg-white p-3 shadow-sm transition-all hover:shadow-md md:block md:h-[280px] md:w-[220px] md:flex-shrink-0 md:overflow-hidden md:p-0 md:shadow-none"
    >
